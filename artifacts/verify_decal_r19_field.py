"""R1.9 canonical six-object field gate, without saving the .blend."""
...
OUTPUT_JSON = Path(
    os.environ.get(
        "CFTUV_R19_FIELD_REPORT",
        str(REPO_ROOT / "artifacts" / "decal_r19_field_acceptance.json"),
    )
)
...
def main():
    ...
    report = {
        "schema": "cftuv.decal_r19.field.v1",
    ...
    print("CFTUV_R19_FIELD=" + json.dumps(report, ensure_ascii=False))
