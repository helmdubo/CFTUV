...
|---|---|---|---|
| BASE-00: recover the canonical integration baseline from `codex/fix-host-reflex-corner-envelope` and apply the amended Envelope v1 execution pack | `ACCEPTED_WITH_DOCS_ONLY_AMENDMENT` | `e4db68371cab83a6a26368bf9a95eda74ae8d02e` | `artifacts/envelope_baseline/session_base_00_handoff.md` |
| DOC-00: canonical control status selects one authority order; historical session documents cannot dispatch work | `READY_FOR_HUMAN_REVIEW` | Implementation SHA recorded in `artifacts/envelope_doc_00/session_doc_00_handoff.md` | `artifacts/envelope_doc_00/session_doc_00_handoff.md` |
