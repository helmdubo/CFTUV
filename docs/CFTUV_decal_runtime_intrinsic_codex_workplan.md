...
инвариантность; (b) планарный — corner-seeded straight wavefront
(спецификация в заметке, раздел S4): event-модель, робастность
(одновременные/вырожденные события, детерминизм, I3-guard'ы),
поэтапная миграция с differential против PatchVoronoi.
