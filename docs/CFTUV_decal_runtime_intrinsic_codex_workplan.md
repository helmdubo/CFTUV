...
вертикальные стенки» с углами как в тесте; routing-строка из
консоли; точный строитель угла (junction fan / CAP / weld-слой).
Гипотезы: не эмитится сектор junction-фана на выпуклом стыке двух
chain'ов; взаимодействие с C8.2-ключами сварки; CAP-зона после
C8.1. Acceptance: на репро ноль дырок на всех ширинах, junction
покрыт полным фаном, differential пересдаётся осознанно.
