...
ребро сгиба, БЕЗ клина. Дизайн-направление (разобрать при
триаже): разложение угла на dihedral fold (обрабатывается
imprint/bend — G1/G1.2) и in-plane turn (только он получает
corner-компенсацию); у crest-углов in-plane составляющая ~0 =>
чистый перегиб, V-клин не должен рождаться. Плюс триаж двух
