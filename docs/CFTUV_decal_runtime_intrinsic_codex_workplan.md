...
4b. **R1.3 — RR9a: перпендикулярный снэп терминального
   ...
   перпендикуляру (снэп направления фолбэка (c) к дискретному
   кандидату; ничья -> плотина; mark сильнее снэпа). На fold-рёбра
   снэп НЕ распространяется (см. закрытие вопроса в RR9a).
