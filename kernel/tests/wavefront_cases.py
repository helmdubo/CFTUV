...
#
# Текущая запись — уже evaluation-bound контур на решётке 32768. Поэтому
# шнуровка даёт РОВНО 27224141715/(2*32768^2), без прежней невязки source-chart
# и без второго скрытого снапа внутри стенда.
FIELD_DENOMINATOR = 32768
FIELD_NUMERATORS = (
    (469074, -101640),
    (212020, -27984),
    (232392, -39678),
