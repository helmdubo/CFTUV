...
# Оси наблюдаемого ответа — общие с теневой сверкой представления тождества
# (`test_exact_identity_shadow.py`). Один набор на обе сверки: две копии
# разошлись бы ровно в тот день, когда одну из них дополнят.
