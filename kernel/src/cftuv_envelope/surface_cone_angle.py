...
# Число десятичных знаков рабочего окна. Ширина оболочки одного угла не больше
# 2·10^{-CONE_ANGLE_DECIMALS}, и это ЕДИНСТВЕННОЕ место, где точность выбрана
# числом, а не выведена: она объявляется в `named_epsilon` и проверяется.
